<table border="0">
    ...
    <tr>
        ...
        <td>预览窗口（向前看的控制周期数）, 用于计算预览时间, 默认0</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>最大转弯角度, 默认 6.1086 / M_PI * 180</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
...
<table border="0">
    ...
    <tr>
        <td>preview_time</td>
        <td>预览时间 = preview_window(默认20) * ts</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
...
<table style="text-align: center;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="1" align="center">0.05</td>
        </tr>
        <tr>
            <td rowspan="1" align="center">0.0</td>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            <td rowspan="1" align="center">R</td>
            <td rowspan="1" align="center">0.1</td>
        </tr>
    </tbody>
    <tbody>
        <tr aria-rowspan="18">
